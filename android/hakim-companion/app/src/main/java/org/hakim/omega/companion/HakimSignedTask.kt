...
object HakimSignedTask {
    ...
    fun accept(context: Context, uri: Uri): String {
        ...
        val raw = runCatching {
            String(Base64.decode(planB64, Base64.URL_SAFE or Base64.NO_WRAP or Base64.NO_PADDING), Charsets.UTF_8)
        ...
        prefs.edit().putString("last_signed_task", "accepted:$requestId").putLong("last_signed_task_ms", now).apply()
