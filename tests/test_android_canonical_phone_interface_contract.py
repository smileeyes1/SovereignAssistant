...
def test_android_package_identity_is_stable_for_in_place_upgrade():
    ...
    assert 'versionName = "0.5.0-canonical-phone-interface"' in gradle


def test_phone_ui_declares_same_canonical_hakim_identity():
    ...
    assert 'ACTIVE_POINTER = "governance/HAKIM_ACTIVE.json"' in identity
