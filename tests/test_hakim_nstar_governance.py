...
def test_restore_chain_is_complete_and_files_exist():
    ...
    expected = [
        ...
        "LOAD_NSTAR_GOVERNING_CONSTITUTION", "LOAD_META_METHOD_SPEC",
    ...
    assert expected.index("LOAD_NSTAR_GOVERNING_CONSTITUTION") < expected.index("LOAD_META_METHOD_SPEC")
    ...
    for key in (
        ...
        "meta_method_spec", "phone_sovereign_constraints", "runtime_policy",
